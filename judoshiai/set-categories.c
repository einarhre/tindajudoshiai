...
struct offial_category official_categories[NUM_DRAWS][2][10] = {
    { // international
        ...
        { // men
            {
                "Männer", 1000, 240, 0, 480, // name, max age, match gs rest times
                {{60000, "-60kg"}, {66000, "-66kg"}, {73000, "-73kg"},
                 {81000, "-81kg"}, {90000, "-90kg"}, {100000, "-100kg"}, {0, NULL}}
            }, {
                "MU21", 20, 240, 0, 480, // name, max age, match gs rest times
                {{55000, "-55kg"}, {60000, "-60kg"}, {66000, "-66kg"}, {73000, "-73kg"},
                 {81000, "-81kg"}, {90000, "-90kg"}, {100000, "-100kg"}, {0, NULL}}
            }, {
                "MU18", 17, 240, 0, 480, // name, max age, match gs rest times
                {{43000, "-43kg"}, {46000, "-46kg"}, {50000, "-50kg"}, {55000, "-55kg"}, {60000, "-60kg"},
                 {66000, "-66kg"}, {73000, "-73kg"}, {81000, "-81kg"}, {90000, "-90kg"}, {0, NULL}}
            }, {
                "mU15", 14, 180, 0, 360, // name, max age, match gs rest times
                {{34000, "-34kg"}, {37000, "-37kg"}, {40000, "-40kg"}, {43000, "-43kg"}, {46000, "-46kg"},
                 {50000, "-50kg"}, {55000, "-55kg"}, {60000, "-60kg"}, {66000, "-66kg"}, {0, NULL}}
            },{
                "mU12", 11, 120, 0, 240, // name, max age, match gs rest times
                {{0, NULL}}
            }, { NULL, 0, 0, 0, 0, {{0, NULL}}}
        }, { // women
            {
                "Frauen", 1000, 240, 0, 480, // name, max age, match gs rest times
                {{48000, "-48kg"}, {52000, "-52kg"}, {57000, "-57kg"},
                 {63000, "-63kg"}, {70000, "-70kg"}, {78000, "-78kg"}, {0, NULL}}
            }, {
                "FU21", 20, 240, 0, 480, // name, max age, match gs rest times
                {{44000, "-44kg"}, {48000, "-48kg"}, {52000, "-52kg"}, {57000, "-57kg"},
                 {63000, "-63kg"}, {70000, "-70kg"}, {78000, "-78kg"}, {0, NULL}}
            }, {
                "FU18", 17, 240, 0, 480, // name, max age, match gs rest times
                {{40000, "-40kg"}, {44000, "-44kg"}, {48000, "-48kg"}, {52000, "-52kg"}, {57000, "-57kg"},
                 {63000, "-63kg"}, {70000, "-70kg"}, {78000, "-78kg"}, {0, NULL}}
            }, {
                "wU15", 14, 180, 0, 360, // name, max age, match gs rest times
                {{32000, "-32kg"}, {36000, "-36kg"}, {40000, "-40kg"}, {44000, "-44kg"},
                 {48000, "-48kg"}, {52000, "-52kg"}, {57000, "-57kg"}, {63000, "-63kg"}, {0, NULL}}
            },{
                "wU12", 11, 120, 0, 240, // name, max age, match gs rest times
                {{0, NULL}}
            }, { NULL, 0, 0, 0, 0, {{0, NULL}}}
        }
    }

...
struct offial_category official_categories[NUM_DRAWS][2][13] = {
    { // international
        { // men
            {
        ...
        { // men
            {
                "Karlar", 1000, 240, 0, 480, // name, max age, match gs rest times
                {{60000, "60"}, {66000, "66"}, {73000, "73"},
                 {81000, "81"}, {90000, "90"}, {100000, "100"}, {0, NULL}}
            }, {
                "KarlarU21", 20, 240, 0, 480, // name, max age, match gs rest times
                {{55000, "55"}, {60000, "60"}, {66000, "66"}, {73000, "73"},
                 {81000, "81"}, {90000, "90"}, {100000, "100"}, {0, NULL}}
            }, {
                "KarlarU18", 17, 180, 0, 360, // name, max age, match gs rest times
                {{50000, "50"}, {55000, "55"}, {60000, "60"}, {66000, "66"},
                 {73000, "73"}, {81000, "81"}, {90000, "90"}, {0, NULL}}
            }, {
                "KarlarU15", 14, 120, 0, 240, // name, max age, match gs rest times
                {{34000, "34"}, {38000, "38"}, {42000, "42"}, {46000, "46"},
                 {50000, "50"}, {55000, "55"}, {60000, "60"}, {66000, "66"},
                 {73000, "73"}, {81000, "81"}, {90000, "90"}, {0, NULL}}
            }, {
                "DrengirU13", 12, 120, 0, 240, // name, max age, match gs rest times
                {{30000, "30"}, {34000, "34"}, {38000, "38"},
                 {42000, "42"}, {46000, "46"}, {50000, "50"}, {55000, "55"},
                 {60000, "60"}, {66000, "66"}, {73000, "73"}, {81000, "81"},
                 {90000, "90"}, {0, NULL}}
            }, {
                "DrengirU11", 10, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"},
                 {27000, "27"}, {30000, "30"}, {34000, "34"}, {38000, "38"},
                 {42000, "42"}, {46000, "46"}, {50000, "50"}, {55000, "55"}, {0, NULL}}
            }, {
                "DrengirU10", 9, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"},
                 {27000, "27"}, {30000, "30"}, {34000, "34"}, {38000, "38"},
                 {42000, "42"}, {46000, "46"}, {50000, "50"}, {55000, "55"}, {0, NULL}}
            }, {
                "DrengirU9", 8, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"},
                 {27000, "27"}, {30000, "30"}, {34000, "34"}, {38000, "38"},
                 {42000, "42"}, {46000, "46"}, {50000, "50"}, {55000, "55"}, {0, NULL}}
            }, {
                "DrengirU8", 7, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"},
                 {27000, "27"}, {30000, "30"}, {34000, "34"}, {38000, "38"},
                 {42000, "42"}, {46000, "46"}, {50000, "50"}, {55000, "55"}, {0, NULL}}
            }, {
                "DrengirU7", 6, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"},
                 {27000, "27"}, {30000, "30"}, {34000, "34"}, {38000, "38"},
                 {42000, "42"}, {46000, "46"}, {50000, "50"}, {55000, "55"}, {0, NULL}}
            }, { NULL, 0, 0, 0, 0, {{0, NULL}}}
            ...
            {
                "Konur", 1000, 240, 0, 480, // name, max age, match gs rest times
                {{48000, "48"}, {52000, "52"}, {57000, "57"},
                 {63000, "63"}, {70000, "70"}, {78000, "78"}, {0, NULL}}
            }, {
                "KonurU21", 20, 240, 0, 480, // name, max age, match gs rest times
                {{44000, "44"}, {48000, "48"}, {52000, "52"}, {57000, "57"},
                 {63000, "63"}, {70000, "70"}, {78000, "78"}, {0, NULL}}
            }, {
                "StúlkurU18", 17, 180, 0, 360, // name, max age, match gs rest times
                {{40000, "40"}, {44000, "44"}, {48000, "48"}, {52000, "52"},
                 {57000, "57"}, {63000, "63"}, {70000, "70"}, {0, NULL}}
            }, {
                "StúlkurU15", 14, 120, 0, 240, // name, max age, match gs rest times
                {{32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {63000, "63"},
                 {70000, "70"}, {0, NULL}}
            }, {
                "StúlkurU13", 12, 120, 0, 240, // name, max age, match gs rest times
                {{32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {63000, "63"},
                 {70000, "70"}, {0, NULL}}
            }, {
                "StúlkurU11", 10, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"}, {28000, "28"},
                 {32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {0, NULL}}
            }, {
                "StúlkurU10", 9, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"}, {28000, "28"},
                 {32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {0, NULL}}
            }, {
                "StúlkurU9", 8, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"}, {28000, "28"},
                 {32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {0, NULL}}
            }, {
                "StúlkurU8", 7, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"}, {28000, "28"},
                 {32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {0, NULL}}
            }, {
                "StúlkurU7", 6, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"}, {28000, "28"},
                 {32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {0, NULL}}
            }

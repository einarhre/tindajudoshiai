        ...
        { // men
            {
                ...
                "Dr. U21", 20, 240, 0, 480, // name, max age, match gs rest times
                {{55000, "55"}, {60000, "60"}, {66000, "66"}, {73000, "73"},
                 {81000, "81"}, {90000, "90"}, {100000, "100"}, {0, NULL}}
            }, {
                "Dr. U18", 17, 180, 0, 360, // name, max age, match gs rest times
                {{50000, "50"}, {55000, "55"}, {60000, "60"}, {66000, "66"},
                 {73000, "73"}, {81000, "81"}, {90000, "90"}, {0, NULL}}
            }, {
                "Dr. U15", 14, 120, 0, 240, // name, max age, match gs rest times
                {{34000, "34"}, {38000, "38"}, {42000, "42"}, {46000, "46"},
                 {50000, "50"}, {55000, "55"}, {60000, "60"}, {66000, "66"},
                 {73000, "73"}, {81000, "81"}, {90000, "90"}, {0, NULL}}
            }, {
                "Dr. U13", 12, 120, 0, 240, // name, max age, match gs rest times
                {{30000, "30"}, {34000, "34"}, {38000, "38"},
                 {42000, "42"}, {46000, "46"}, {50000, "50"}, {55000, "55"},
                 {60000, "60"}, {66000, "66"}, {73000, "73"}, {81000, "81"},
                 {90000, "90"}, {0, NULL}}
            }, {
                "Dr. U11", 10, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"},
                 {27000, "27"}, {30000, "30"}, {34000, "34"}, {38000, "38"},
                 {42000, "42"}, {46000, "46"}, {50000, "50"}, {55000, "55"}, {0, NULL}}
            }, {
                "Dr. U10", 9, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"},
                 {27000, "27"}, {30000, "30"}, {34000, "34"}, {38000, "38"},
                 {42000, "42"}, {46000, "46"}, {50000, "50"}, {55000, "55"}, {0, NULL}}
            }, {
                "Dr. U9", 8, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"},
                 {27000, "27"}, {30000, "30"}, {34000, "34"}, {38000, "38"},
                 {42000, "42"}, {46000, "46"}, {50000, "50"}, {55000, "55"}, {0, NULL}}
            }, {
                "Dr. U8", 7, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"},
                 {27000, "27"}, {30000, "30"}, {34000, "34"}, {38000, "38"},
                 {42000, "42"}, {46000, "46"}, {50000, "50"}, {55000, "55"}, {0, NULL}}
            }, {
                "Dr. U7", 6, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"},
                 {27000, "27"}, {30000, "30"}, {34000, "34"}, {38000, "38"},
                 {42000, "42"}, {46000, "46"}, {50000, "50"}, {55000, "55"}, {0, NULL}}
            }, { NULL, 0, 0, 0, 0, {{0, NULL}}}
        }, { // women
            {
                ...
                "St. U21", 20, 240, 0, 480, // name, max age, match gs rest times
                {{44000, "44"}, {48000, "48"}, {52000, "52"}, {57000, "57"},
                 {63000, "63"}, {70000, "70"}, {78000, "78"}, {0, NULL}}
            }, {
                "St. U18", 17, 180, 0, 360, // name, max age, match gs rest times
                {{40000, "40"}, {44000, "44"}, {48000, "48"}, {52000, "52"},
                 {57000, "57"}, {63000, "63"}, {70000, "70"}, {0, NULL}}
            }, {
                "St. U15", 14, 120, 0, 240, // name, max age, match gs rest times
                {{32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {63000, "63"},
                 {70000, "70"}, {0, NULL}}
            }, {
                "St. U13", 12, 120, 0, 240, // name, max age, match gs rest times
                {{32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {63000, "63"},
                 {70000, "70"}, {0, NULL}}
            }, {
                "St. U11", 10, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"}, {28000, "28"},
                 {32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {0, NULL}}
            }, {
                "St. U10", 9, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"}, {28000, "28"},
                 {32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {0, NULL}}
            }, {
                "St. U9", 8, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"}, {28000, "28"},
                 {32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {0, NULL}}
            }, {
                "St. U8", 7, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"}, {28000, "28"},
                 {32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {0, NULL}}
            }, {
                "St. U7", 6, 120, 0, 240, // name, max age, match gs rest times
                {{21000, "21"}, {23000, "23"}, {25000, "25"}, {28000, "28"},
                 {32000, "32"}, {36000, "36"}, {40000, "40"}, {44000, "44"},
                 {48000, "48"}, {52000, "52"}, {57000, "57"}, {0, NULL}}
            }

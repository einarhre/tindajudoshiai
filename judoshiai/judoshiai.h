...
enum {
    ...
    COL_VISIBLE_COMMENT1,
    COL_VISIBLE_COMMENT2,
    COL_VISIBLE_COMMENT3,
...
extern void db_delete_cat_def_table_age(const gchar *agetext);
...
extern void edit_category_dialog(gint ix, gboolean is_team);
